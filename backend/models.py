...
from sqlalchemy import (
    Column, Integer, String, Boolean, Text, Date, DateTime, ForeignKey, Numeric, UniqueConstraint
)
...
class InviteCode(Base):
    """Single-use registration invite generated by an existing account."""
    ...
    created_by = relationship("Account", foreign_keys=[created_by_account_id])
    used_by = relationship("Account", foreign_keys=[used_by_account_id])
